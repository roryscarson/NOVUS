...
class BalanceSheet_B_Pnl(scrolled.ScrolledPanel):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        # BS List Objects 
        #------------------------------------------------------------------
        self.yearList = [self.balanceSht_lbl, self.forecast_lbl, self.actual_lbl]
        ...
        # Asset Panels:
        self.cash_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.shtTermInv_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.ar_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.inventory_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.totalCA_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.ppeGrosss_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.accumDep_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.ppeNet_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.totalAssets_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        # Assets Panel List
        ...
        # Liability Panels:
        self.ap_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.stf_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.LoC_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.currentLTD_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.totalCL_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.ltd_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.totalLiabilities_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        ...
        # Equity Panels:
        self.commonStock_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.capitalSurplus_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.retainedEarnings_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.totalEquity_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        self.totalLiabEquity_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
        # Equity Panel List
        ...
        # Share Info Panel:
        self.commonSharesOut_pnl = X_miscPnls.Report2_Row_Pnl(self, -1)
    ...
    #----------------------------------------------------------------------
    def UpdateBS(self, bsList, isPF=True):
