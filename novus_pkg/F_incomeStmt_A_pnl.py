...
This module contains the Income Statement "A" Panel class code for the Novus 
...
class IncomeStmt_A_Pnl(scrolled.ScrolledPanel):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        #       for each year
        #------------------------------------------------------------------
        self.yearList = [self.incomeStmt_lbl, self.year_lbl+' 1', self.year_lbl+' 2',
        ...
        self.revenue_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.rev_AK_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.rev_AB_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.rev_AC_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.rev_LK_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.rev_LB_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.rev_LC_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.totalRevenue_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.cogs_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.cogs_AK_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.cogs_AB_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.cogs_AC_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.cogs_LK_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.cogs_LB_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.cogs_LC_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.totalCogs_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        
        self.invSpoilExp_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.overProdExp_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        
        self.adjCogs_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.adjCogs_AK_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.adjCogs_AB_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.adjCogs_AC_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.adjCogs_LK_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.adjCogs_LB_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.adjCogs_LC_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.totalAdjCogs_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        
        self.grossIncome_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.grossIncome_AK_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.grossIncome_AB_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.grossIncome_AC_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.grossIncome_LK_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.grossIncome_LB_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.grossIncome_LC_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.totalGrossIncome_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.grossMargin_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.grossMargin_AK_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.grossMargin_AB_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.grossMargin_AC_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.grossMargin_LK_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.grossMargin_LB_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.grossMargin_LC_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.totalGrossMargin_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.salaryWages_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.rent_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.utilities_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.fuelExp_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.marketingExp_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.prodDevExp_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.otherExp_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.totalOpExp_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.ebitda_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.depAmt_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.ebit_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.intIncome_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.intExp_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.ebt_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.taxes_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.netIncome_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.sharesOut_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
        self.eps_pnl = X_miscPnls.Report1_Row_Pnl(self, -1)
    ...
    def UpdateIS(self, isList, year):
        ...
        try:
            ...
            eps = 0
        self.eps_pnl.AddFloat(eps, insCol)
        
        self.Scroll(0, 0)
        
    #----------------------------------------------------------------------
    def Reset(self):
        '''Resets the result Income Statement panels.'''
        for pnl, fld in zip(self.IS_pnls, self.IS_fields):
            bold, italic = False, False
            if fld in self.bold_list:
                bold = True
