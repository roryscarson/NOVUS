...
'''
The module contains the code for the Intro Panel for the
Novus program.
'''

import wx
import B_yearList_pnl, X_picture_pnl
import X_styles, X_utilities

class YearSelect_Pnl(wx.Panel):
    '''This class is for the Intro Panel object for the Novus program.'''
    def __init__(self, parent, *args, **kwargs):
        super(YearSelect_Pnl, self).__init__(parent, *args, **kwargs)
        ...
        self.year_pnl = B_yearList_pnl.YearList_Pnl(self)
        h_box.Add(self.year_pnl, 5, wx.EXPAND|wx.RIGHT, 15)
